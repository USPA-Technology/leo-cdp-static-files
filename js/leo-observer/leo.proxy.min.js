/*
 * LEO JS code for LEO CDP - version 0.8.8 - built on September 14, 2021
 */
...
"function"===typeof d.synchLeoVisitorCallback&&d.synchLeoVisitorCallback(a.substring(18))};(function(a,b,c){a.addEventListener?a.addEventListener(b,c,!1):a.attachEvent&&a.attachEvent("on"+b,c)})(window,"message",function(a){console.log("===> host.e.origin "+a.origin+" data "+a.data);a.origin===n&&d.messageHandler(a.data)});var g=function(a,b,c,h,k,l,p,q){var e=encodeURIComponent(document.referrer),w=r(document.referrer),x=encodeURIComponent(window.srcTouchpointName||document.title),y=r(document.location.href),

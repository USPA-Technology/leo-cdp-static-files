/*
 * LEO JS code for LEO CDP - version 1.0 - built on Mar 21 2021
 */
...
f(a))};d.updateProfileBySession=function(a,b){if("object"===typeof a){var c=JSON.stringify({call:"updateProfile",params:g(!1,!1,a,b)});f(c)}};window.LeoObserverProxy=d}})();